...
export const fanStandCopy: Record<FanStandLanguage, FanStandCopy> = {
  en: {
    ...
    title: "Match room",
    description: "Cheer for your side, compare viewpoints, and keep your own match memories.",
    allFans: "All fans",
    ...
    voices: "Fan viewpoints",
    scenario: "Example takes",
  ...
  zh: {
    kicker: "球迷互动",
    title: "比赛看台",
    description: "边看边聊，为喜欢的球队加油，留下自己的比赛记忆。",
    allFans: "全部球迷",
  ...
  es: {
    ...
    description: "Anima a tu equipo, compara puntos de vista y guarda tus recuerdos del partido.",
    allFans: "Todos",
    ...
    voices: "Puntos de vista",
    scenario: "Opiniones de ejemplo",
  ...
  pt: {
    ...
    description: "Torça pelo seu time, compare opiniões e guarde suas memórias da partida.",
    allFans: "Todos",
    ...
    voices: "Visões da torcida",
    scenario: "Opiniões de exemplo",
  ...
  fr: {
    ...
    description: "Encouragez votre équipe, comparez les avis et gardez vos souvenirs du match.",
    ...
    voices: "Points de vue des tribunes",
    scenario: "Avis d'exemple",
  ...
  de: {
    ...
    title: "Spielraum",
    description: "Fiebere mit deinem Team, vergleiche Ansichten und halte deine Spielmomente fest.",
    allFans: "Alle Fans",
    teamFans: (team) => `${team}-Fans`,
    ...
    voices: "Stimmen aus den Kurven",
    scenario: "Beispielstimmen",
  ...
  ja: {
    kicker: "ファン交流",
    title: "マッチルーム",
    description: "応援するチームに声を送り、いろいろな見方を比べ、試合の記憶を残せます。",
    allFans: "すべてのファン",
  ...
  ar: {
    ...
    title: "غرفة المباراة",
    description: "شجع فريقك وقارن الآراء واحتفظ بذكرياتك عن المباراة.",
    allFans: "كل المشجعين",
    ...
    voices: "وجهات نظر المدرجات",
    scenario: "آراء نموذجية",
