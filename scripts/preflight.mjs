...
const requiredFiles = [
  ...
  "docs/LOCAL_FUNCTION_DEMO_ROUND_1_2026-07-14.md",
  "docs/LOCAL_FUNCTION_DEMO_ROUND_2_2026-07-14.md",
  "docs/UX_REPORT_FIRST_TIME_FAN_2026-07-14.md",
  "docs/UX_REPORT_RETURNING_COMMUNITY_FAN_2026-07-14.md",
  "docs/UX_REPORT_MOBILE_GLOBAL_JUDGE_2026-07-14.md",
  "docs/LOCAL_ACCEPTANCE_SUMMARY_2026-07-14.md",
  "api/txline/[...path].mjs",
  ...
  "src/data/fanStandCopy.ts",
  "src/components/FanStand.tsx",
  "src/components/PulsePlay.tsx",
...
const requiredText = [
  ...
  ["docs/DEMO_SCRIPT.md", "Hard maximum: 5:00"],
  ["docs/DEMO_SCRIPT.md", "explicitly approves recording"],
  ...
  ["docs/ROUND_MASTER_TASKS_2026-07-12.md", "当前工作树通过数据、可用性、语言/移动端/安全三轮本地验收"],
  ["docs/ROUND_MASTER_TASKS_2026-07-12.md", "只有项目所有者明确同意后"],
  ...
  ["docs/LOCAL_FUNCTION_DEMO_ROUND_1_2026-07-14.md", "本地功能链路通过"],
  ["docs/LOCAL_FUNCTION_DEMO_ROUND_2_2026-07-14.md", "本地完整球迷旅程通过"],
  ["docs/UX_REPORT_FIRST_TIME_FAN_2026-07-14.md", "第一次进入不需要教程"],
  ["docs/UX_REPORT_RETURNING_COMMUNITY_FAN_2026-07-14.md", "社区价值建立在真实本地行为"],
  ["docs/UX_REPORT_MOBILE_GLOBAL_JUDGE_2026-07-14.md", "移动端和国际化本地验收通过"],
