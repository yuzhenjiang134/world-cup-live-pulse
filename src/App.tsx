...
const copy = {
  en: {
    ...
    sourceNeedsTokenMessage:
      "Activate the hackathon devnet free-tier token first, then add it to local .env.local only.",
    ...
    endpointPending: "Waiting for local devnet token and access verification",
  ...
  zh: {
    ...
    endpointPending: "等待本地 devnet token 与权限验证",
...
const localizedCopy = {
  ...
  es: {
    ...
    endpointPending: "Esperando token devnet local y verificación de acceso",
  ...
  pt: {
    ...
    endpointPending: "Aguardando token devnet local e verificação de acesso",
  ...
  fr: {
    ...
    endpointPending: "En attente du token devnet local et de la vérification d'accès",
  ...
  de: {
    ...
    endpointPending: "Warten auf lokalen Devnet-Token und Zugriffsprüfung",
  ...
  ja: {
    ...
    endpointPending: "ローカル devnet token とアクセス確認待ち",
  ...
  ar: {
    ...
    endpointPending: "بانتظار رمز devnet المحلي والتحقق من الوصول",
